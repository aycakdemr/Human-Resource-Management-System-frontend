...
export default function ConfirmAdvertDetail() {
    let approvedAdvertService= new ApprovedAdvertsService();
    let { id } = useParams();
    ...
    const formik = useFormik({
        ...
        onSubmit: (value) => {
          approvedAdvertService.add(value).then((result) =>
            console.log(value),
            toast.success(`İLAN ONAYLANDI`)
          );
        },
      });
    return (
